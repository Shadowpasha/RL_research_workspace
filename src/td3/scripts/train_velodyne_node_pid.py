...
class td3(object):
    def __init__(self, state_dim, action_dim, max_action):
        ...
        self.writer = SummaryWriter(log_dir="/root/ros2_ws/src/td3/scripts/runs/pid")
...
class GazeboEnv(Node):
    ...
    def __init__(self):
        ...
        self.pid =  PID(0.2,0.05,0.0005,0.1,1.0,(-2.5,2.5),(-0.4,0.4))
...
if __name__ == '__main__':
    ...
    file_name = "td3_velodyne_pid"  # name of the file to store the policy
    ...
    writer = SummaryWriter(log_dir="/root/ros2_ws/src/td3/scripts/runs/pid")
    writer_reward = 0
    episode_reward = 0
