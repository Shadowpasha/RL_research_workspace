...
if __name__ == '__main__':
    ...
    max_ep = 500
    file_name = "td3_velodyne_transformer"  # name of the file to load the policy from
    environment_dim = 20
    robot_dim = 4
    ...
    try:
        network.load(file_name, "/root/ros2_ws/src/td3/scripts/pytorch_models")
    except:
    ...
    while rclpy.ok():
        ...
        if done:
           ...
           break
            ...
            a_in = [((action[0]*1.0 + 1) / 2.0)*2.2, -action[1]*1.6]  #0.7 0.6  #1.0 0.7
