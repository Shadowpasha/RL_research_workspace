...
if __name__ == '__main__':
    ...
    if not os.path.exists("/home/anas/ros2_ws/src/td3/scripts/results"):
        os.makedirs("/home/anas/ros2_ws/src/td3/scripts/results")
    if save_model and not os.path.exists("/home/anas/ros2_ws/src/td3/scripts/pytorch_models"):
        os.makedirs("/home/anas/ros2_ws/src/td3/scripts/pytorch_models")
    ...
    if load_model:
        try:
            ...
            network.load(load_name, "/home/anas/ros2_ws/src/td3/scripts/pytorch_models")
        except:
            ...
            if timestep < max_timesteps:
                ...
                if done:
                    ...
                    if timesteps_since_eval >= eval_freq:
                        ...
                        network.save(file_name, directory="/home/anas/ros2_ws/src/td3/scripts/pytorch_models")
                        # np.save("/home/anas/ros2_ws/src/td3/scripts//results/%s" % (file_name), evaluations)
                        epoch += 1
