...
class td3(object):
    def __init__(self, state_dim, action_dim, max_action):
        ...
        self.writer = SummaryWriter(log_dir="/root/ros2_ws/src/td3/scripts/runs/transformer_variable-" + datetime.now().strftime("%y-%m-%d-%H-%M"))
...
if __name__ == '__main__':
    ...
    file_name = "td3_velodyne_transformer_variable-"  + datetime.now().strftime("%y-%m-%d-%H-%M") # name of the file to store the policy
    ...
    writer = SummaryWriter(log_dir="/root/ros2_ws/src/td3/scripts/runs/transformer_variable-" + datetime.now().strftime("%y-%m-%d-%H-%M"))
    writer_reward = 0
    episode_reward = 0
