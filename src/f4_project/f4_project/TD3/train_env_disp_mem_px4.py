...
class DroneGazeboEnv(gym.Env):
    ...
    def position_cb(self,msg):
        ...
        orientation_q[0] = self.pose.orientation.x
        orientation_q[1] = self.pose.orientation.y
        orientation_q[2] = self.pose.orientation.z
        orientation_q[3] = self.pose.orientation.w
